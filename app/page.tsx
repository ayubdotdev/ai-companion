...
import { Brain, Sparkles, Zap, Loader2, BookOpen, Users, Target,   MessageCircle, Headphones, Settings, Play } from 'lucide-react';
...
const Hero = () => {
    ...
    return (
        ...
        <div className="w-full dark:bg-black relative z-10">
                        ...
                        <div className="grid md:grid-cols-3 gap-6 max-w-6xl mx-auto mb-20 px-4">
                            {features.map((feature, index) => (
                                ...
                                >
                                    ...
                                    <p className="text-slate-600 dark:text-gray-600 leading-relaxed text-sm">
                                        {feature.description}
                                    </p>
                                </motion.div>
                            ))}
                ...
                <section className="py-16 bg-slate-50 dark:bg-black relative z-10">
                    <div className="max-w-7xl mx-auto px-4">
                        ...
                        >
                            ...
                            <p className="text-lg text-slate-600 dark:text-gray-600 max-w-2xl mx-auto">
                ...
                <section className="py-16 bg-white dark:bg-black relative z-10">
                    <div className="max-w-7xl mx-auto px-4">
                        <motion.div
                            initial={{ opacity: 0, y: 20 }}
                            whileInView={{ opacity: 1, y: 0 }}
                ...
                {/* Get Started Section - Just Above Footer */}
                <section className="py-16 bg-slate-50 dark:bg-black relative z-10">
                    <div className="max-w-7xl mx-auto px-4">
                        <motion.div
                            initial={{ opacity: 0, y: 20 }}
                        ...
                        >
                            ...
                            <p className="text-lg text-slate-600 dark:text-gray-600 max-w-2xl mx-auto mb-8">
                ...
                {/* Footer */}
                <footer className="dark:bg-black dark:text-white py-16 relative z-10">
                    <div className="max-w-7xl mx-auto px-4">
                        <div className="grid md:grid-cols-4 gap-8">
                            <div className="col-span-2">
                                <h3 className="text-2xl font-bold mb-4">EduNova</h3>
                                <p className="dark:text-slate-300 mb-6 max-w-md">
                            ...
                            <div>
                                ...
                                <ul className="space-y-2">
                                    <li><Link href="#" className="text-gray-600 hover:text-white transition-colors">Features</Link></li>
                                    <li><Link href="#" className="text-gray-600 hover:text-white transition-colors">Pricing</Link></li>
                                    <li><Link href="#" className="text-gray-600 hover:text-white transition-colors">Companions</Link></li>
                                    <li><Link href="#" className="text-gray-600 hover:text-white transition-colors">API</Link></li>
                                </ul>
                            </div>
                            ...
                            <div>
                                ...
                                <ul className="space-y-2">
                                    <li><Link href="#" className="text-gray-600 hover:text-white transition-colors">Help Center</Link></li>
                                    <li><Link href="#" className="text-gray-600 hover:text-white transition-colors">Contact Us</Link></li>
                                    <li><Link href="#" className="text-gray-600 hover:text-white transition-colors">Privacy Policy</Link></li>
                                    <li><Link href="#" className="text-gray-600 hover:text-white transition-colors">Terms of Service</Link></li>
                                </ul>
                            </div>
                        </div>
